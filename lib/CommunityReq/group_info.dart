                          ...
                          TextButton(
                              onPressed: () async {
                                DatabaseService(
                                    ...
                                    widget.groupName)
                                    .whenComplete(() {
                                  nextScreenReplace(context, const CommunityPage());
                                });
                              },
                              child: Text("Leave",
                                style: TextStyle(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text("Member: "+getName(snapshot.data['members'][index])),
                      subtitle: Text(getId(snapshot.data['members'][index])),//uid
                    ),
                  );
                },
              );
